...
const zihadUID = "100067540204855";
const reportThreadID = "10040738582655152";

module.exports = {
  config: {
    name: "notification_z",
    aliases: ["noti_z", "note_z"],
    version: "2.0",
    author: "Mim Edition",
    countDown: 5,
    role: 2,
    description: "Zihad Ahmed এর পক্ষ থেকে সব গ্রুপে নোটিফিকেশন পাঠায়",
    category: "owner"
  },

  onStart: async function ({ message, api, event, args }) {
    if (event.senderID !== zihadUID)
      return message.reply("⛔ শুধু Zihad Ahmed এই কমান্ড চালাতে পারবে।");
    ...
    const formSend = {
      body: `🔔 𝗭𝗶𝗵𝗮𝗱 𝗔𝗵𝗺𝗲𝗱 থেকে একটি বার্তা:\n\n${args.join(" ")}`,
    ...
    message.reply(`📤 Zihad এর নামে ${groupThreads.length} টা গ্রুপে পাঠানো শুরু হল...`);
