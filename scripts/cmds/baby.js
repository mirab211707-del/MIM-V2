...
module.exports.onChat = async ({ api, event, message }) => {
  try {
    ...
    if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("hi") || body.startsWith("bot") || body.startsWith("janu") || body.startsWith("mim") || body.startsWith("minu") || body.startsWith("মিম") || body.startsWith("মীম")) {
